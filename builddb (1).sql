...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2018 at 10:33 PM
...
(32, 'z1', 'z1', '1', 'z1', '1', 'z1', 1, '2018-05-13', '2018-05-13', 'active', 0x6e756c6c, 'a6163151a1a9263b3fa0a1ec8173389c318ce63e615da222f0eb67f04a7dcc95f07ecd46e451ac8964854968a842d2af350db884629d76a5ae2c164537'),
(33, 'ntest', 'ntest', '778932123', 'ntest', '980570428v', 'ntest', 1, '2018-05-13', '2018-05-13', 'active', 0x6e756c6c, 'b366da540ad60f72da830e3f84a7fc99eec72c83f38af85a8998dc1e41c44daf41e2cc3f1065f85668f4594b09e796895c78041cc41bec7444e87e4766a3'),
(34, 'nmtest', 'nmtest', '778932123', 'nmtest', '980578543v', 'nmtest', 1, '2018-05-13', '2018-05-13', 'active', 0x6e756c6c, '4a377ad1e16c26106558996a646b523d8d25e688e7e3df7fdc60a29434a1f9fda4d795cfd959132fdf1a1478553c36948c4981f55db48eb20d329428d1c5');
...
INSERT INTO `project` (`ID`, `Name`, `Owner`, `Status`, `Start_Date`, `End_Date`, `Est_Start`, `Est_End`, `Location_Address`, `Description`) VALUES
(1, 'newproj', 33, 'ongoing', '2018-05-01', '2018-05-11', '2018-05-01', '2018-05-11', 'mahargama', 'mharama newproject'),
(2, 'proj2', 33, 'ongoing', '2018-05-01', '2018-05-10', '2018-05-01', '2018-05-10', 'mahargama', 'maharagma project2');
...
INSERT INTO `project_workers` (`Project_Id`, `Cus_Id`, `Contractor_Id`, `Architect_Id`, `IntDesigner_Id`, `Quantity_surv_Id`, `Carpenter_Id`) VALUES
(1, 34, NULL, 9, 7, 11, 13);
...
(6, 'c10', '10', 'c10', 'c10', '2018-05-13', '2018-05-13', 'active', 0x6e756c6c, 'bceef87152ef48b3ff702ecc5e5a47c8ddb170c024278bf25028cf35deab4daebe60a9de8378eec3c6fa151060c920281853818ef8934737b9cceb22655f3d1', 10);
...
INSERT INTO `task` (`Task_ID`, `Project_ID`, `Name`, `Status`, `Start_Date`, `End_Date`, `Est_Start`, `Est_End`, `Description`, `Moderator_Id`) VALUES
(1, 1, 'start build', 'ongoing', '2018-05-01', '2018-05-03', '2018-05-01', '2018-05-16', 'start!', 13),
(2, 1, 'start tiling', 'ongoing', '2018-05-03', '2018-05-10', '2018-05-03', '2018-05-12', 'tile', 11);
...
ALTER TABLE `project_workers`
  ...
  ADD KEY `IntDesigner_Id` (`IntDesigner_Id`),
  ADD KEY `Quantity_surv_Id` (`Quantity_surv_Id`),
...
ALTER TABLE `project_workers`
  ...
  ADD CONSTRAINT `project_workers_ibfk_3` FOREIGN KEY (`Contractor_Id`) REFERENCES `business_user` (`ID`),
  ADD CONSTRAINT `project_workers_ibfk_4` FOREIGN KEY (`Architect_Id`) REFERENCES `business_user` (`ID`),
  ADD CONSTRAINT `project_workers_ibfk_5` FOREIGN KEY (`IntDesigner_Id`) REFERENCES `business_user` (`ID`),
  ADD CONSTRAINT `project_workers_ibfk_6` FOREIGN KEY (`Quantity_surv_Id`) REFERENCES `business_user` (`ID`),
  ADD CONSTRAINT `project_workers_ibfk_7` FOREIGN KEY (`Carpenter_Id`) REFERENCES `business_user` (`ID`);
